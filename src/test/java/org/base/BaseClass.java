...
public class BaseClass {
	...
	public WebElement findElement(String elementType,String path) {
			
		switch (elementType) {
		case "id":
			WebElement elementById = driver.findElement(By.id(path));
			return elementById;
			
		case "xpath" :
			
			WebElement elementByXpath = driver.findElement(By.xpath(path));
			return elementByXpath;
			
		case "class" :
			
			WebElement elementByClass = driver.findElement(By.className(path));
